...
<div id='output_image'></div>
                    ...
                    if (file_exists("../../admin/release3.txt") || !is_numeric($_SESSION["role"])) {
                        ...
                        echo "<a href='../../scorer/indexSE.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View/Submit Robot Game Round 1 Score</a><br />";
                        echo "<a href='../../scorer/indexSE.php?round=2&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View/Submit Robot Game Round 2 Score</a><br />";
                        echo "<a href='../../scorer/indexSE.php?round=3&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View/Submit Robot Game Round 3 Score</a><br />";
                    }
                    if ($_SESSION["role"] == "Tournament Director" || $_SESSION["role"] == "Judge" || $_SESSION["role"] == "Referee") {
                        echo "<br><h3>Edit Final Scores:</h3>";

                        $teamno = basename(dirname(__FILE__));
                        echo "<a href='../../scorer/index.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>Edit Robot Game Round 1 Score</a><br />";
                        echo "<a href='../../scorer/index.php?round=2&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>Edit Robot Game Round 2 Score</a><br />";
                        echo "<a href='../../scorer/index.php?round=3&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>Edit Robot Game Round 3 Score</a><br />";

                        echo "<a href='../../rubrics/project.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>Edit Innovation Project Judging Rubric</a><br />";
                        echo "<a href='../../rubrics/robot.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>Edit Robot Design Judging Rubric</a><br />";
                        echo "<a href='../../rubrics/corevalues.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>Edit Core Values Judging Rubric</a><br />";
                    }
                    ...
                    if (file_exists("../../admin/release2.txt")) {
                        if (file_exists("robotScores/1.txt")) {
                            echo "<a href='../../scorer/indexRO.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View Robot Game Round 1 Score</a><br />";
                        }
                        if (file_exists("robotScores/2.txt")) {
                            echo "<a href='../../scorer/indexRO.php?round=2&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View Robot Game Round 2 Score</a><br />";
                        }
                        if (file_exists("robotScores/3.txt")) {
                            echo "<a href='../../scorer/indexRO.php?round=3&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/score-icon.png'>View Robot Game Round 3 Score</a><br />";
                        }
                    }
                    if (file_exists("../../admin/release.txt")) {
                        if (file_exists("robotScores/rb-rp.txt")) {
                            echo "<a href='../../rubrics/projectRO.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>View Innovation Project Judging Rubric</a><br />";
                        }
                        if (file_exists("robotScores/rb-rd.txt")) {
                            echo "<a href='../../rubrics/robotRO.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>View Robot Design Judging Rubric</a><br />";
                        }
                        if (file_exists("robotScores/rb-cv.txt")) {
                            echo "<a href='../../rubrics/corevaluesRO.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.flltutorials.com/images/rubric-icon.png'>View Core Values Judging Rubric</a><br />";
                        }
                    }
                    ?>
                </body>
