...
<head>
  ...
  <title>Video <?php echo $_GET["file"]; ?></title>
  ...
  <div>
    ...
    <section>
      <div class="text-body" style="font-size: 12px;">
        ...
        <video controls="controls" width="100%" height="600" name="<?php echo $_GET["file"]; ?>">
  <source src="<?php echo $_GET["file"]; ?>">
</video>
<br><br><p>
If you are having trouble viewing the video, click <a href="<?php echo $_GET["file"]; ?>">here</a> to download it.
    </p>
        <br>
        </p>
      </div>
