    ...
    <section>
      <div class="text-body" style="font-size: 12px;">
        <p style="font-size: 150%;">
          ...
          if ($_SESSION["role"] == "Referee" || $_SESSION["role"] == "Tournament Director") {
            echo '
          <b>Referees:</b> You can score teams in the <a href="scorer/loadscorer.php">Score Manager</a>. Select the team you want to score and the correct round. Once you
          press "Save", the score will be added to the <a href="readscores.html">Scoreboard</a>.
           <br><br>
          ';
          }
          ...
          if ($_SESSION["role"] == "Judge" || $_SESSION["role"] == "Tournament Director") {
            echo '
          <b>Judge:</b> You can judge teams using the digitized FLL rubrics at <a href="rubrics/loadrb.php">Rubric Manager</a> Select the team and the core area you wish to judge.
          <br>
          <br>
          ';
          } ?>

          <b>Everyone:</b> You can view published robot scores at the <a href="readscores.html">Scoreboard</a>.<br><br>
...
-->
          <br>
          <!-- <video controls=""><source src="http://smegabyte.dyndns.org:8000/Ortop.ogg" type="application/ogg"></video> -->
