...
function addELevels(color1,color2,color3,color4) {
    addToBuffer('<td></td><td></td><td  class="rbtd" style="text-align: center;font-weight: bold;">Beginning<br></td><td  class="rbtd" style="text-align: center;font-weight: bold;">Accomplished<br></td><td style="text-align: center;font-weight: bold;"  class="rbtd">Exceeds<br></td>')
}
...
function addEStrengths(item1, item2, item3, item4, item5, item6) {
    addToBuffer('    <fieldset data-role="controlgroup">    <td colspan="5">\
<input class="rbitem" type="checkbox" id="'+item1.split(" ")[0]+item1.split(" ")[1]+'" name="'+item1.split(" ")[0]+item1.split(" ")[1]+'">\
<label for="'+item1.split(" ")[0]+item1.split(" ")[1]+'">'+item1+'</label>\
    <label for="'+item2.split(" ")[0]+item2.split(" ")[1]+'">\
    '+item2+'\
            <input class="rbitem" type="checkbox" id="'+item2.split(" ")[0]+item2.split(" ")[1]+'" name="'+item2.split(" ")[0]+item2.split(" ")[1]+'">    </label>\
    \
    <label for="'+item3.split(" ")[0]+item3.split(" ")[1]+'">'+item3+'\
            <input class="rbitem" type="checkbox" id="'+item3.split(" ")[0]+item3.split(" ")[1]+'" name="'+item3.split(" ")[0]+item3.split(" ")[1]+'">    </label>\
    <label for="'+item4.split(" ")[0]+item4.split(" ")[1]+'">'+item4+'\
            <input class="rbitem" type="checkbox" id="'+item4.split(" ")[0]+item4.split(" ")[1]+'" name="'+item4.split(" ")[0]+item4.split(" ")[1]+'">    </label>\
    <label for="'+item5.split(" ")[0]+item5.split(" ")[1]+'">'+item5+'\
            <input class="rbitem" type="checkbox" id="'+item5.split(" ")[0]+item5.split(" ")[1]+'" name="'+item5.split(" ")[0]+item5.split(" ")[1]+'">    </label>\
    \
    </fieldset>    ')
}
{/* <label for="'+item6.split(" ")[0]+item6.split(" ")[1]+'">'+item6+'\
        <input class="rbitem" type="checkbox" id="'+item6.split(" ")[0]+item6.split(" ")[1]+'" name="'+item6.split(" ")[0]+item6.split(" ")[1]+'">    </label>\
\ */}
