        ...
        <table style="width:98%; text-align:center; margin-left:auto; margin-right:auto;border:none!important;">
            <tr>
                ...
                <td style="width:50%; font-size:24px; text-align:center">
                    <b id="title">FLL Submerged Scorer</b> (Self-evaluation)
                </td>
                <td style="width:25%; font-size:12px; text-align:right">
                    <img alt="FLL..." style="border:1px solid #021a40;" src="assets/images/FLL.png" height="57">  <img alt="FLL Tutorials" style="border:1px solid #021a40;" src="assets/images/flltutorials.png" width="139"><img class="only-mobile" alt="FLL Tutorials" style="border:1px solid #021a40;" src="assets/images/flltutorials.png" width="139">
                </td>
            </tr>
        </table>
