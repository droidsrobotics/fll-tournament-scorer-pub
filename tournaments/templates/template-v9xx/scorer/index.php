...
<head>
    ...
    <script src="assets/js/saver_new.js"></script>
...
input.btn-check {
  display: none !important
    ...
    <script>
        versionNum = "Scorer 6.1.0 Embedded MD (Tournament)"
versionDay = 5
versionMonth = 8
versionYear = 2025
versionText = ""
        ...
        <div id="contentload" style="display: none;">
            ...
            <table style="width:98%; text-align:center; margin-left:auto; margin-right:auto;border:none!important;">
                <tr>
                    ...
                    <td style="width:50%; font-size:24px; text-align:center">
                        <b id="title">FLL UNEARTHED Scorer</b>
                    </td>
            ...
            <div data-role="tabs">
                ...
                <div id="tabs-1">
                    ...
                    <div class="only-print" style="width:100%; background-color:grey; color: white; text-align: center;">
                        <i id="pointsTxt2">Points</i><i> </i><i id="allpoints2"> 0</i>
                    </div>

                    <div class="no-print" data-hide-during-focus="" data-tap-toggle="false" data-role="footer" style="position:fixed;bottom:0;width:100%;text-align:center; font-size: 50%; background-color:grey; color: white;z-index:100;" data-theme="a" data-position="fixed">
                        <h1 style="font-size:250%; padding-left: 10px;padding-top:5; padding-bottom:0"><b id="pointsTxt">Points:</b><i>: </b><i id="allpoints">
                                0</i> &emsp; &emsp; <input class="btn btn-danger" id="resetTxt" type="button" value="Reset" class="ui-mini no-print" onclick="document.getElementById('missions').reset();loadsave(blanksave);check_missions();">
                    ...
                    <div style="max-width:500px;margin:5px;">
                        ...
                        <form action="" id="serverForm" method="post">
                            ...
                            <textarea class="form-control" name="pubnotes"><?php echo file_get_contents("../teams/" . $_GET['team'] . "/robotScores/".$_GET['round'] ."-pub.txt"); ?></textarea>


                            <h3>Referee's Notes (Private)</h3>
                            <textarea class="form-control" name="privnotes"><?php echo file_get_contents("../teams/" . $_GET['team'] . "/robotScoresPriv/".$_GET['round'] ."-priv.txt"); ?></textarea>
                            
                           <br>
                            <input type="checkbox" id="scoreboard" name="scoreboard" checked="checked">
                            <label for="scoreboard"> Save to Scoreboard</label><br>
                        </form>
                        <button class="btn btn-success" onclick="savetoserver();" id="saverTscorer" type="button">Save Score</button>
                        <br><br><br><br><br>
