...
if (isset($_POST['text']))
{
  $log = exec('cp -rfv ../../templates/template-v9xx/* ../ &> upgrade.log');
...
$latest = trim(file_get_contents("../../templates/template-v9xx/version.txt"));
...
Changelog:
<?php
echo file_get_contents("../../templates/template-v9xx/changelog.txt");
?>
</pre>
<!--
<br><br><br><br>
