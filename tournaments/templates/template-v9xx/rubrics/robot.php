...
<script src="https://unpkg.com/onsenui/js/onsenui.min.js"></script>
  ...
  height: auto !important;
    ...
    <script>
        versionNum = "6.1.0 Embedded MD Branch"
versionDay = 5
versionMonth = 8
versionYear = 2025
versionText = ""
...
<section>
          ...
          }, 100);" style="max-width: 500px" type="reset" class="btn btn-danger">Reset</button>
                    </form>
                </div>
                <br><br>
                <div id="tabs-4">
                    ...
                    <form action="" id="serverForm" method="post">
                        ...
                        <h3>Judge's Notes (Private)</h3>
                            <textarea class="form-control" name="privnotes"><?php echo file_get_contents("../teams/" . $_GET['team'] . "/robotScoresPriv/rd-priv.txt"); ?></textarea>
                            <b>Label color:</b>
                    ...
                    <br><br>
                    <button class="btn btn-success" onclick="savetoserver();" id="saverTscorer" type="button">Save</button>
                    </div>
                    <br><br><br><br><br>
