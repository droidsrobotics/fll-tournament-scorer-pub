          ...
          <head>
            ...
            <script type="text/javascript">
              ...
              function gentable(teamin, n) {
                ...
                document.write('  <td><a target="_blank" href="../teams/' + fwteam + '">' + teamin.split(',')[1] + '</a> '+teamScores[n + 3]+'</td>');
            ...
            <table class="styled-table" border="1" id="my_table">
              <thead>
                <tr style="background-color: lightgrey;text-align:center;">
                  ...
                  <th style="max-width: 80px;"><button style="background-color: transparent;border-color: transparent; width: 100%;" onclick="sortTable(3)">Innovation Project</button></th>
