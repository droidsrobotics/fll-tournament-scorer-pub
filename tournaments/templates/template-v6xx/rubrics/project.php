...
function getParameterByName(name, url) {
  ...
  if (getParameterByName('team') != null) {
  document.write('<b style="font-size: 150%; text-align:right;">Team No: '+getParameterByName('team')+'</b>')
...
<script>
  ...
  function savetoserver() {
    ...
    var currentTime = new Date()
            ...
            teamSV = (team).toLocaleString('en-US', {minimumIntegerDigits: 8, useGrouping:false})
            round = 0
            score = getRBSaveStr()
            points = (parseInt(document.getElementById("projpts").innerHTML)).toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false})
